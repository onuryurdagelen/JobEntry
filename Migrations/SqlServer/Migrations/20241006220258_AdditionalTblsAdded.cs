...
{
    public partial class AdditionalTblsAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Instructions_Informations_InformationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Properties_ProductProperties_ProductPropertyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WishesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WishProducts", x => new { x.ProductsId, x.WishesId });
                    table.ForeignKey(
                        name: "FK_WishProducts_Products_ProductsId",
                        column: x => x.ProductsId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WishProducts_Wishes_WishesId",
                        column: x => x.WishesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Instructions_InformationId",
                table: "Instructions",
                column: "InformationId");

            migrationBuilder.CreateIndex(
                name: "IX_Properties_ProductPropertyId",
                table: "Properties",
