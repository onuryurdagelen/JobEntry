    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CriterionDrivingLicenses", x => new { x.CriterionId, x.DrivingLicenseId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CriterionEducationLevels", x => new { x.CriterionId, x.EducationLevelId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CriterionExperiences", x => new { x.CriterionId, x.ExperienceId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CriterionMilitaryStatuses", x => new { x.CriterionId, x.MilitaryStatusId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkPreferenceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CriterionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    JobLanguageId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    PositionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DepartmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    PositionLevelId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobApplicants", x => new { x.Applicant_Id, x.Job_Id });
                    table.ForeignKey(
